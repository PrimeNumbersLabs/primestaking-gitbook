...
After buying a V2 NFT you can migrate it to V3 in a single transaction, keeping the same `tokenId` and rarity with lock state preserved. See [Migrate XDC NFTs to V3](migrate-nfts-v2-to-v3.md).
{% endhint %}
