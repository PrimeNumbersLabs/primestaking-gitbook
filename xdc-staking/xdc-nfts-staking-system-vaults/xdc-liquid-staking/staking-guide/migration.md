...
{% hint style="info" %}
Migration is optional at any individual point in time, but V3.2 is the only version with self-service withdrawals, share-price reward accrual, and NFT-boost compatibility. See [Legacy (V2, historical)](../../../../legacy/README.md).
{% endhint %}
...
→ [Withdrawals: Instant vs Queued (V3.2)](withdrawals-instant-vs-queued.md) → [V2 vs V3: What Changed](../v2-vs-v3.md) → [Historical pstXDC → psXDC migration (legacy)](../../../../legacy/pstxdc-migration.md)
