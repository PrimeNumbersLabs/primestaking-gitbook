...
**What happens to my V2 psXDC staked inside the NFT?** It's redeemed from the old façade, bridged into V3 shares through the [`PrimeStakedXDC_V3MigrationBridge`](../xdc-liquid-staking/staking-guide/migration.md), and staked into the new vault under your new NFT, with the same `tokenId` and rarity.
