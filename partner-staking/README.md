...
Each pool is a deployment of [`PartnerStakedXDC_V3`](smart-contract-reference.md), a self-contained, fee-bearing copy of the PrimeStaking flagship [`PrimeStakedXDC_V3_2`](../xdc-staking/xdc-nfts-staking-system-vaults/xdc-liquid-staking/v3-architecture.md) vault. It is a fully independent contract: separate state, separate token, separate admin keys, separate masternode operators. It shares no storage, funds, or permissions with the flagship vault.
